...
async def convert(
    ...
    index_rate: float = Form(0.75, description="index mix ratio (0.0 ~ 1.0)"),
...
async def start_training(
    ...
    gpus: str = Form("0-1-2-3", description="GPU IDs for training (dash-separated, e.g. 0-1-2-3)"),
    gpus_rmvpe: str = Form("0-1-2-3", description="GPU IDs for rmvpe_gpu (dash-separated)"),
